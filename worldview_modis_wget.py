...
if args.format == 'jpeg':
	if args.formatsize == 'small':
		url = 'http://map2.vis.earthdata.nasa.gov/image-download?TIME='+args.year+''+doy+'&extent='+args.bbox[0]+','+args.bbox[1]+','+args.bbox[2]+','+args.bbox[3]+'&epsg=4326&layers=MODIS_Terra_CorrectedReflectance_TrueColor,Coastlines&opacities=1,1&worldfile=false&format=image/jpeg&width=386&height=544'
		...
		url = 'http://map2.vis.earthdata.nasa.gov/image-download?TIME='+args.year+''+doy+'&extent='+args.bbox[0]+','+args.bbox[1]+','+args.bbox[2]+','+args.bbox[3]+'&epsg=4326&layers=MODIS_Terra_CorrectedReflectance_TrueColor,Coastlines&opacities=1,1&worldfile=false&format=image/jpeg&width=1928&height=2720'
	...
	if args.formatsize == 'small':
		url = 'http://map2.vis.earthdata.nasa.gov/image-download?TIME='+args.year+''+doy+'&extent='+args.bbox[0]+','+args.bbox[1]+','+args.bbox[2]+','+args.bbox[3]+'&epsg=4326&layers=MODIS_Terra_CorrectedReflectance_TrueColor,Coastlines&opacities=1,1&worldfile=false&format=image/png&width=386&height=544'
		...
		url = 'http://map2.vis.earthdata.nasa.gov/image-download?TIME='+args.year+''+doy+'&extent='+args.bbox[0]+','+args.bbox[1]+','+args.bbox[2]+','+args.bbox[3]+'&epsg=4326&layers=MODIS_Terra_CorrectedReflectance_TrueColor,Coastlines&opacities=1,1&worldfile=false&format=image/png&width=1928&height=2720'
